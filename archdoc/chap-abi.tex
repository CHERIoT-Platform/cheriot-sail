...
\begin{table}
	\begin{center}
		\begin{tabular}{l|l|p{7cm}}
			...
			\asm{CHERIOT_COMPARTMENT_HI}         & 220 & 20-bit, 11-bit shifted \PCC- or \CGP-relative displacement for use in \insnref{auicgp} or \insnref{auipcc}. The instruction must be followed by a four-byte \asm{nop}, which may be used to convert the reference into a load from an global offset table when it would otherwise be out of range. \\
